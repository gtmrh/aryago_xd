...
class Slectavailablecab extends StatelessWidget {
  // Slectavailablecab({
  //   required Key key,
  // }) : super(key: key);
  @override
      ...
      body: Padding(
        ...
        child: Stack(
          children: <Widget>[
            ...
            Pinned.fromPins(
              Pin(size: 205.0, middle: 0.3297),
              Pin(size: 21.0, start: 40.0),
              child: Text(
                'Distance 109KM, Time 3:23hr',
                style: TextStyle(
                  fontFamily: 'Segoe UI',
                  fontSize: 16,
            ...
            Pinned.fromPins(
              Pin(size: 65.0, end: 28.0),
              Pin(size: 24.0, middle: 0.1939),
              child: Text(
                '2482.60',
                style: TextStyle(
                  fontFamily: 'Segoe UI',
